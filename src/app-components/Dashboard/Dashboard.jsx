    ...
    return (
      <section>
        <StyledArticle>
          ...
          <span>в </span>
          <a href='https://lobastov.livejournal.com/tag/%D0%9F%D1%83%D1%82%D0%B5%D1%88%D0%B5%D1%81%D1%82%D0%B2%D0%B8%D0%B5'>дороге</a>
          <span>. Это не все.</span>
        </StyledArticle>
        <StyledArticle>
          Мудрость, которую можно усмотреть на этой странице в том,
          что большие дела начинаются с малого.
        </StyledArticle>
      </section>
    );
  }
