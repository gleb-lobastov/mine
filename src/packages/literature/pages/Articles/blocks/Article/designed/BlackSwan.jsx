...
function BlackSwan() {
  return (
    <Container>
      <Header>
        <Reference>
          <a href="https://lobastov.livejournal.com/5718.html">Опубликовано</a>
      ...
      <main>
        ...
        <Paragraph>
          ...
          поберечь (начало войны, финансовый кризис, увольнение с&nbsp;работы),
          есть и&nbsp;Черные Лебеди сулящие невероятный успех тем, кто имеет
          с&nbsp;ними дело: научные открытия, популярность, успешные стартапы.
          Да, вероятность стать автором бестселлера или новым Цукербергом крайне
          низка, практически невозможна. Тем не&nbsp;менее кто-то
          из&nbsp;пытающихся рано или поздно получит приз, но&nbsp;почти все
          останутся ни&nbsp;с&nbsp;чем.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          ...
          с&nbsp;оценкой вероятности, в&nbsp;соответствии с&nbsp;книгой. Примеры
          тоже в&nbsp;основном взяты из&nbsp;книги. Если захотите изучить эти
          заблуждения подробнее, заказать книгу можно, например, здесь.
        </Paragraph>
        <Paragraph>
          ...
          человек кормит, поит и&nbsp;убирает за&nbsp;ней всю ее&nbsp;жизнь. Что
          она может себе подумать? Что человек&nbsp;&mdash; друг, доброе
        ...
        <Paragraph>
          ...
          верным&nbsp;&mdash; не&nbsp;ищите ему подтверждений, попытайтесь лучше
          его опровергнуть. Хоть и&nbsp;очень трудно искать опровержение идее,
          что приходится по&nbsp;душе, но&nbsp;это имеет смысл и&nbsp;ценность.
          Искать&nbsp;же подтверждения&nbsp;&mdash; бессмысленно, так как
          не&nbsp;смотря на&nbsp;кажущуюся пользу они не&nbsp;увеличивают
          имеющиеся знания (а&nbsp;могут даже уменьшать).
        </Paragraph>
        <Paragraph>
          ...
          не&nbsp;равнозначны, но&nbsp;мы&nbsp;обычно не&nbsp;замечаем, как наш
          мозг производит подобные подмены.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          ...
          за&nbsp;ним от&nbsp;горя умерла Королева&raquo;. Кажется вторая фраза
          звучит органичнее.
        </Paragraph>
        <Paragraph>
          Так вот, возвращаясь к&nbsp;теме&nbsp;&mdash; когда
          мы&nbsp;воспринимаем окружающий мир или делимся познаниями
          другим&nbsp;&mdash; мы&nbsp;пользуемся нарративом, мы&nbsp;укладываем
          факты во&nbsp;взаимосвязанную логическую цепочку, в&nbsp;которой есть
          четко обозначенные причины и&nbsp;следствия. Однако события,
          происходящее в&nbsp;мире, более случайны, не&nbsp;всегда так
          уж&nbsp;легко определить что и&nbsp;почему произошло. Бывает, что одно
          и&nbsp;то-же событие можно объяснить несколькими разными,
          но&nbsp;логичными способами. Что предрешило исход Куликовской Битвы?
          Историки пишут&nbsp;&mdash; засадный полк, но&nbsp;может дело решил
          превосходный моральный дух наших бойцов, или своевременный контрудар,
          или плохой вчерашний обед монголов, а&nbsp;может роль сыграла погода
          и&nbsp;был важен численный перевес? Насколько вообще мы&nbsp;можем
          дать однозначный ответ? Любая причинно-следственная логика окажется
          более-менее спорной и&nbsp;так с&nbsp;каждым историческим событием.
          Задумайтесь об&nbsp;этом в&nbsp;следующий раз, когда будете наводить
        ...
        <Paragraph>
          ...
          из&nbsp;ревности&raquo;, какой вариант по&nbsp;вашему более вероятный?
        </Paragraph>
        <Paragraph>
          На&nbsp;самом деле первый вариант, так как он&nbsp;более общий, второй
          вариант, когда &laquo;он&raquo; убил жену из&nbsp;ревности, это
          частный случай первого, а&nbsp;ведь &laquo;он&raquo; мог убить жену
          например из-за наследства или из-за того, что она была смертельно
          больна и&nbsp;страдала. Тем не&nbsp;менее большинство опрошенных
          указывает на&nbsp;второй вариант.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          ...
          на&nbsp;выставки. Но&nbsp;галереи не&nbsp;высоко оценивают его работы,
          покупатели находятся с&nbsp;трудом и&nbsp;ваш приятель еле сводит
          концы с&nbsp;концами. А&nbsp;у&nbsp;него возможно есть и&nbsp;семья,
          жена, дети. И&nbsp;вроде-бы все ничего, они готовы потерпеть нужду,
          понятно, что признание не&nbsp;приходит сразу. Но&nbsp;вот, ваш друг
          с&nbsp;семьей в&nbsp;гостях у&nbsp;старого приятеля, разговор зашел
          о&nbsp;работе. Приятель работает в&nbsp;офисе, постоянная зарплата,
          новая машина, недавно вот ремонт дома сделал. Возникает неловкая
          пауза. И&nbsp;по&nbsp;дороге домой жена как&nbsp;бы невзначай говорит,
          вот&nbsp;бы и&nbsp;нам так устроится. Нужно иметь каменное сердце,
          что&nbsp;бы не&nbsp;почувствовать тоску в&nbsp;такой момент. Трудно
          идти против течения, против мнения близких людей и&nbsp;против того,
          что в&nbsp;обществе считается нормой. Тем более, когда результат еще
        ...
        <Paragraph>
          ...
          скрытые свидетельства, не&nbsp;принимая их&nbsp;во&nbsp;внимание можно
          сильно отклониться от&nbsp;истины в&nbsp;своих суждениях.
        </Paragraph>
        <Paragraph>
          ...
          в&nbsp;них секрет успеха. Первые при этом искренне стараются, находят
          объяснение, как и&nbsp;почему они смогли достичь таких высот.
          Однако&nbsp;же настоящий секрет в&nbsp;том, что счастливчикам
          несколько раз повезло, в&nbsp;ответственный момент. Да, конечно они
          много трудились и&nbsp;это важное условие победы, но&nbsp;есть&nbsp;же
          и&nbsp;их&nbsp;антиподы&nbsp;&mdash; не&nbsp;менее способные
          и&nbsp;трудолюбивые предприниматели, однажды поставившие
          не&nbsp;на&nbsp;ту&nbsp;лошадку. Такие ребята никогда не&nbsp;попадут
          в&nbsp;список бизнес-икон и&nbsp;не&nbsp;напишут для нас книг
          об&nbsp;истории своего краха. Мы&nbsp;о&nbsp;них никогда
          ...
          А&nbsp;на&nbsp;глобальный уровень выйдет только один на&nbsp;миллион.
          И&nbsp;стоит учитывать существование этого миллиона,
        ...
        <Paragraph>
          ...
          представления о&nbsp;мире в&nbsp;чем-то аналогичны карте, более того,
          все научные и&nbsp;практические теории тоже являются в&nbsp;своем роде
          картами и&nbsp;по&nbsp;научному называются моделями. Так вот карты
          ...
          правила можно &laquo;играть&raquo; руководствуясь ими. В&nbsp;какой-то
          момент мы&nbsp;обнаруживаем, что с&nbsp;нами-то жизнь по&nbsp;правилам
          не&nbsp;играет.
        </Paragraph>
        <Paragraph>
          Представьте, что у&nbsp;меня есть идеальная, честная монетка,
          у&nbsp;которой орел и&nbsp;решка выпадают с&nbsp;равной вероятностью.
          Я&nbsp;кидаю монетку 99&nbsp;раз и&nbsp;99&nbsp;раз выпадает орел.
          Какова вероятность, что на&nbsp;сотый раз выпадет решка? Если&nbsp;вы,
          следуя теории вероятности ответите, что каждый случай
          мы&nbsp;рассматриваем отдельно и&nbsp;вероятность будет&nbsp;50%
          на&nbsp;50%, то&nbsp;вы&nbsp;то&nbsp;и&nbsp;падете жертвой игровой
          ошибки (здесь высшее образование играет отрицательную роль). Жизнь
          не&nbsp;играет с&nbsp;нами по&nbsp;правилам, если вы&nbsp;встретите
          в&nbsp;жизни ситуацию, когда 99&nbsp;раз выпадет одна сторона,
          то&nbsp;будьте уверены, что монетка с&nbsp;подвохом. Вероятность
          выпадения решки будет не&nbsp;больше 1-го процента. Если монетка
          была&nbsp;бы идеальная, то&nbsp;по&nbsp;теории вероятности, ради такой
          серии пришлось&nbsp;бы кидать ее&nbsp;куда дольше, чем существует наша
          вселенная.
        </Paragraph>
        <Paragraph>
          <ParagraphTitle>Что еще?</ParagraphTitle>
          Кроме ошибок суждения влияющих на&nbsp;оценки риска
          и&nbsp;возможностей в&nbsp;книге подробно рассмотрена сама возможность
          предсказания, речь идет о&nbsp;сложности и&nbsp;невозможности
          прогнозирования. Причем эта ограниченность имеет физический характер
          и&nbsp;никак не&nbsp;зависит от&nbsp;наших интеллектуальных
          способностей и&nbsp;технологических возможностей. Первый отскок
          бильярдного шара легко прикинуть в&nbsp;уме, второй&nbsp;&mdash;
          сложнее но&nbsp;тоже можно, третий можно рассчитать зная несколько
          формул и&nbsp;характеристик стола и&nbsp;шара. Для расчета четвертого
          удара уже нужна геометрия кия, а&nbsp;для седьмого&nbsp;&mdash;
          гравитационное воздействие на&nbsp;шар игроков. Дальше больше.
        </Paragraph>
        <Paragraph>
          Все еще верите в&nbsp;предсказания на&nbsp;длительный период? Возьмите
          прогноз развития, план на&nbsp;будущее любого государства или
          корпорации за&nbsp;дату в&nbsp;тридцать лет назад и&nbsp;сравните его
          с&nbsp;результатом.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          ...
          взялась&nbsp;ли лужица на&nbsp;столе из-за растаявшего льда или кто-то
          неаккуратно пронес графин с&nbsp;водой уже так-то просто
          не&nbsp;определить.
        </Paragraph>
        <Paragraph>
          В&nbsp;отдельной главе, в&nbsp;книге сравнивается традиционная модель
          оценки рисков, основанной на&nbsp;кривой нормального распределения
          (гауссиане) с&nbsp;альтернативными подходами. И&nbsp;соответствие этих
          методов реальности. Выводы далеко не&nbsp;в&nbsp;пользу гауссовой
          кривой. Проводится разбор ошибок и&nbsp;соответствующих
          им&nbsp;глобальных угроз, связанных с&nbsp;распространением
          традиционной модели.
        </Paragraph>
        <Paragraph>
          В&nbsp;заключении автор делиться своей стратегией действий в&nbsp;мире
          живущем по&nbsp;правилам Черных Лебедей
        </Paragraph>
      </main>
    </Container>
  );
